...
NON_TITLE_REGEX = re.compile(r'\.(?:\(?(?:19|20)[0-9]{2}\)?|480p|576p|720p|1080p|1080i|2160p|NTSC|PAL|STV|PPF|R5|DVDSCR|SCREENER|DVDRip|BDRip|LIMITED|COMPLETE|PROPER|REPACK|RERiP|TS|TELESYNC|CAM|FESTIVAL|SUBBED)\..*', re.IGNORECASE)
...
RESOLUTION_REGEX = re.compile(r'\.(2160p|1080p|1080i|720p|480p|576p)(\.|\-|$)', re.IGNORECASE)
